...
const CREATE_INPUT = {
  ...
  deliveryMonth: "exampleDeliveryMonth",
  id: "exampleId",
  paymentDate: new Date(),
  paymentReceived: "true",
  paymentTime: new Date(),
  thankYouMessage: "exampleThankYouMessage",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /deliveries", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        paymentTime: CREATE_RESULT.paymentTime.toISOString(),
      ...
      .expect([
        {
          ...
          paymentTime: FIND_MANY_RESULT[0].paymentTime.toISOString(),
  ...
  test("GET /deliveries/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        paymentTime: FIND_ONE_RESULT.paymentTime.toISOString(),
